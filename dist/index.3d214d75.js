...
const pSecure = (0, _redom.el)("p.secure", "Secure Checkout");
const divCreditCard = (0, _redom.el)("div.credit-card");
const spanCardNumber = (0, _redom.el)("span.card__number", "xxxx xxxx xxxx xxxx");
const divCardPersonal = (0, _redom.el)("div.card__personal");
const spanCardName = (0, _redom.el)("span.card__name", "John Doe");
const spanCardDate = (0, _redom.el)("span.card__date", "MM/YY");
const form = (0, _redom.el)("form#form.form", {
    action: "#"
});
const divInputWrapHolder = (0, _redom.el)("div.form__input-wrap.form__input-wrap_holder");
...
const divInputWrapNumber = (0, _redom.el)("div.form__input-wrap.form__input-wrap_number");
...
const divInputWrapDate = (0, _redom.el)("div.form__input-wrap.form__input-wrap_date");
const labelDate = (0, _redom.el)("label.form__label.form__date-label", "Card Expiry");
...
const divInputWrapCVV = (0, _redom.el)("div.form__input-wrap.form__input-wrap_cvv");
const labelCVV = (0, _redom.el)("label.form__label.form__cvv-label", "CVV");
...
},{"redom":"iahd6","@parcel/transformer-js/src/esmodule-helpers.js":"dVOym","credit-card-input-mask":"bO9Hm"}],"iahd6":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
},{"69678c37e1e62446":"eR489"}]},["9vOdb","bB7Pu"], "bB7Pu", "parcelRequirec832")
